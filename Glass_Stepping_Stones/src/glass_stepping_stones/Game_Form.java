...
public class Game_Form extends javax.swing.JFrame {
	boolean firstTwoBoxesUsed = false;
    ...
    public void addAction()
    {
        ...
        boolean hasSteppedOnFirstTile = false; // To track if player stepped on the first tile
        boolean hasSteppedOnSecondTile = false;
        // jpanel2
        for(Component comp : comp1)
        {
            if(comp instanceof JLabel)
            {
                ...
                label.addMouseListener(new java.awt.event.MouseAdapter() {
                    ...
                    {
                        if(label.isEnabled() && (counter < 2 || !firstTwoBoxesUsed))
                        {
            ...
            if (comp instanceof JLabel) {
                ...
                label.addMouseListener(new java.awt.event.MouseAdapter() {
                    ...
                    public void mouseClicked(java.awt.event.MouseEvent evt) {
                        if (label.isEnabled()) {
                            if (counter == 0) {
                                // Check if it's one of the first two tiles
                                if (label != jLabel_1_1 && label != jLabel_2_1) {
                                    jLabel_message.setText("You are disqualified!");
